# CC0 instrument samples

The selected files in this directory are used by the browser player. Only a
small subset of each library is included so the page stays reasonably light.
